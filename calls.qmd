...
We do not have an active call at the moment. If you want to check out our previous calls for ideas on what things look like, please use the following:

GOOGLE DOCS LINK WHEN ACTIVE

Replicating Experimental Linguistic Phenomena across ManyLanguages 

# Deadlines

A two-page Expression-of-Interest statement is due on XX. 

The deadline for the submission of Full Proposals will be the XX. See other deadlines at the bottom of this document.
...
The following manuscript components are required for all full proposals for any ManyLanguages call:\
...
- Expression-of-Interest deadline: XX

- Initial feasibility and quality review: XX

- Full Proposal deadline: XX

- Reviewer selection: XX

- Network rating solicitation: XX

- Review submission deadline: XX

- Network rating deadline: XX

- Study selection decision: XX

Possible submission outcomes include “desk rejection” upon initial review, rejection upon full review, provisional acceptance, or an invitation to revise and resubmit. Following a successful period of needs assessment, preparation, personnel identification, lab recruitment, and pre-registration, provisionally selected studies will commence working with pre-study review teams in XX.
